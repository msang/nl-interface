...
def acquire_time_intervals(tracker: Tracker) -> List[Tuple[datetime, datetime]]:
...
def time_constraint(entity):
    ...
    for value in values:
        if value['type'] == 'value':
                ...
                end_time = start_time  # Per un tempo singolo, start_time ed end_time acquisiscono lo stesso valore --> perché dovrebbero? in realtà dipende!
